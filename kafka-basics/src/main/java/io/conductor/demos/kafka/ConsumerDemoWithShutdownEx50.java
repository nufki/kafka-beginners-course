...
// This was a very good exercise to demonstrate how consumer group rebalancing works with the clean shutdown
// Start 3 times this ConsumerDemoWithShutdownEx50 and run the ProducerDemoKeys. Each consumer will be assigned a partition to consume from
// When shutting down a consumer the other will receive a rebalance of partitions...
public class ConsumerDemoWithShutdownEx50 {
    private static final Logger log = LoggerFactory.getLogger(ConsumerDemoWithShutdownEx50.class.getSimpleName());

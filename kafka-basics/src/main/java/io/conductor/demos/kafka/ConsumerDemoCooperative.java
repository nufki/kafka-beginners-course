...
/*
 Default is (the first one): partition.assignment.strategy = [class org.apache.kafka.clients.consumer.RangeAssignor, class org.apache.kafka.clients.consumer.CooperativeStickyAssignor]
 */
...
//        properties.setProperty("security.protocol", "PLAIN");
        ...
        properties.setProperty("partition.assignment.strategy", CooperativeStickyAssignor.class.getName()); // overrideto CooperativeStickyAssignor
